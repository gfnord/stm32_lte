...
MEMORY
    {
    FLASH (rx) : ORIGIN = (0x8000000 + 0), LENGTH = (2048*1K - 0)
    SRAM (wx) : ORIGIN = 0x20000000, LENGTH = (640 * 1K)
    IDT_LIST (wx) : ORIGIN = (0x20000000 + (640 * 1K)), LENGTH = 2K
    }
ENTRY("__start")
SECTIONS
    {
 ...
 *(".kernel.*")
  ...
  *(".net_l2.data")
  ...
  __net_l2_data_end = .;
    ...
    _image_ram_end = .;
    _end = .;
    __kernel_ram_end = 0x20000000 + (640 * 1K);
